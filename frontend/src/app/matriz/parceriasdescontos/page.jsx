  ...
  return (
    <>
      ...
      <div className="flex gap-6 mb-6 relative">
        <button ref={refs.parcerias} onClick={() => setActiveTab("parcerias")} className={`${activeTab === "parcerias" ? "text-pink-500" : "text-gray-700"} hover:text-pink-500 focus:outline-none transition-colors duration-300 ease-in-out`}>Parcerias</button>
        <button ref={refs.descontos} onClick={() => setActiveTab("descontos")} className={`${activeTab === "descontos" ? "text-pink-500" : "text-gray-700"} hover:text-pink-500 focus:outline-none transition-colors duration-300 ease-in-out`}>Descontos</button>
        ...
        {activeTab === "parcerias" && (
          <section>
            ...
            <button onClick={() => {
              ...
              className="flex items-center gap-1 border p-2 rounded-md bg-blue-500 text-white mt-2 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
            >
